...
class Ui_LyricsPage(object):
    def setupUi(self, LyricsPage):
        ...
        self.LyricsTransVerticalLayout_2.addWidget(self.non_trans_radioButton)
    ...
    def retranslateUi(self, LyricsPage):
        ...
        self.non_trans_radioButton.setText(_translate("LyricsPage", "不显示翻译"))
        self.trans_radioButton.setText(_translate("LyricsPage", "显示中文翻译"))
        self.romaji_radioButton.setText(_translate("LyricsPage", "显示罗马音译"))
