# Form implementation generated from reading ui file 'E:\code\git-code\Spotify-lyrics-window\SpotifyLyricWindow\resource\ui\ui_file\LyricsDownloadDialog.ui'
#
...
class Ui_LyricsDownloadDialog(object):
    def setupUi(self, LyricsDownloadDialog):
        ...
        self.buttons_frame = QtWidgets.QFrame(parent=LyricsDownloadDialog)
        ...
        spacerItem = QtWidgets.QSpacerItem(163, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.buttons_horizontalLayout.addItem(spacerItem)
        self.download_button = QtWidgets.QPushButton(parent=self.buttons_frame)
        ...
        self.cancel_button = QtWidgets.QPushButton(parent=self.buttons_frame)
        ...
        self.search_button = QtWidgets.QPushButton(parent=LyricsDownloadDialog)
        ...
        self.search_lineEdit = QtWidgets.QLineEdit(parent=LyricsDownloadDialog)
        ...
        self.music_frame = QtWidgets.QFrame(parent=LyricsDownloadDialog)
        ...
        self.search_tableWidget = QtWidgets.QTableWidget(parent=LyricsDownloadDialog)
