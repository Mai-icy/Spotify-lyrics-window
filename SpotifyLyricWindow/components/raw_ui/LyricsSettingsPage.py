...
class Ui_LyricsSettingsPage(object):
    def setupUi(self, LyricsSettingsPage):
        ...
        self.shadow_color_button = PushButton(self.shadow_color_frame)
        ...
        self.lyrics_color_button = PushButton(self.lyrics_color_frame)
...
from qfluentwidgets import CheckBox, ComboBox, PushButton, RadioButton
