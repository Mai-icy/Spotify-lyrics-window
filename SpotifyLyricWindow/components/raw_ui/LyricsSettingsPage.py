...
class Ui_LyricsSettingsPage(object):
    def setupUi(self, LyricsSettingsPage):
        ...
        self.translation_font_label = QtWidgets.QLabel(parent=self.font_frame)
        self.translation_font_label.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.translation_font_comboBox = QtWidgets.QComboBox(parent=self.font_frame)
        self.translation_font_comboBox.setMinimumSize(QtCore.QSize(0, 32))
        self.translation_font_comboBox.setMaximumSize(QtCore.QSize(200, 16777215))
        ...
        self.translation_font_comboBox.setCurrentIndex(-1)
    ...
    def retranslateUi(self, LyricsSettingsPage):
        ...
        self.font_label.setText(_translate("LyricsSettingsPage", "歌词字体:"))
        self.translation_font_label.setText(_translate("LyricsSettingsPage", "译文字体:"))
