...
- **Separate proxies**: set `spotify_proxy_ip`, `cloudmusic_proxy_ip`, and `kugou_proxy_ip` under `[CommonConfig.ClientConfig]`. An empty value means no explicit proxy is assigned to that service.
