...
class Ui_LyricsDownloadDialog(object):
    def setupUi(self, LyricsDownloadDialog):
        ...
        self.search_lineEdit.setObjectName("songname_lineEdit")
    ...
    def retranslateUi(self, LyricsDownloadDialog):
        ...
        self.image_label.setText(_translate("LyricsDownloadDialog", "TextLabel"))
        self.songname_label.setText(_translate("LyricsDownloadDialog", "TextLabel"))
        self.singer_label.setText(_translate("LyricsDownloadDialog", "TextLabel"))
