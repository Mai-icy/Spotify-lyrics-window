...
# Form implementation generated from reading ui file 'C:\Users\Mai Icy\Desktop\git_code\Spotify-lyrics-window\SpotifyLyricWindow\resource\ui\ui_file\LyricsSettingsPage.ui'
#
...
class Ui_LyricsSettingsPage(object):
    def setupUi(self, LyricsSettingsPage):
        ...
        self.lyrics_default_button = PushButton(self.change_color_frame)
        ...
        self.shadow_color_label.setMinimumSize(QtCore.QSize(80, 32))
        self.shadow_color_label.setMaximumSize(QtCore.QSize(80, 32))
        ...
        self.shadow_color_button = ColorPickerButton(QColor("#5012aaa2"), 'Color2', self.shadow_color_frame)
        self.shadow_color_button.setMinimumSize(QtCore.QSize(40, 32))
        self.shadow_color_button.setMaximumSize(QtCore.QSize(40, 16777215))
        ...
        self.lyrics_color_label.setMinimumSize(QtCore.QSize(80, 32))
        self.lyrics_color_label.setMaximumSize(QtCore.QSize(80, 32))
        ...
        self.lyrics_color_button = ColorPickerButton(QColor("#5012aaa2"), 'Color1', self.lyrics_color_frame)
        self.lyrics_color_button.setMinimumSize(QtCore.QSize(40, 32))
        self.lyrics_color_button.setMaximumSize(QtCore.QSize(40, 16777215))
        self.lyrics_color_button.setText("")
        ...
        self.color_comboBox = ComboBox(self.change_color_frame)
        ...
        self.non_trans_radioButton = RadioButton(self.lyrics_trans_frame)
        ...
        self.enable_front_checkBox = CheckBox(self.always_front_frame)
        ...
        self.display_mode_comboBox = ComboBox(self.display_mode_frame)
    ...
    def retranslateUi(self, LyricsSettingsPage):
        ...
        self.shadow_color_label.setText(_translate("LyricsSettingsPage", "阴影颜色"))
        self.lyrics_color_label.setText(_translate("LyricsSettingsPage", "歌词颜色"))
...
from qfluentwidgets import CheckBox, ColorPickerButton, ComboBox, PushButton, RadioButton
