...
class Ui_LyricsSettingsPage(object):
    def setupUi(self, LyricsSettingsPage):
        ...
        self.lyricssettingspage_gridLayout.addWidget(self.change_color_frame, 3, 0, 1, 1)
        ...
        self.lyricssettingspage_gridLayout.addWidget(self.font_frame, 2, 0, 1, 1)
        ...
        self.lyricssettingspage_gridLayout.addWidget(self.always_front_frame, 1, 0, 1, 1)
