...
class Ui_SettingsWindow:
    def setupUi(self, window):
        ...
        side.setSpacing(8)
        brand_icon = control(self, 'brand_icon_label', QLabel())
        brand_icon.setFixedSize(32, 32)
        brand_icon.setPixmap(window.windowIcon().pixmap(QSize(32, 32), window.devicePixelRatioF()))
        brand_icon.setAccessibleName('Spotify Lyrics')
        brand = horizontal(brand_icon, label('Spotify Lyrics', 'brand'))
