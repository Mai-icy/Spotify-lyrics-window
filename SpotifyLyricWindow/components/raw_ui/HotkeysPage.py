...
class Ui_HotkeysPage(object):
    def setupUi(self, HotkeysPage):
        ...
        HotkeysPage.resize(400, 376)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        HotkeysPage.setFont(font)
        self.gridLayout = QtWidgets.QGridLayout(HotkeysPage)
        ...
        self.gridLayout.addWidget(self.hotkeys_frame, 0, 0, 1, 2)
        self.enable_hotkeys_checkBox = QtWidgets.QCheckBox(HotkeysPage)
        ...
        self.gridLayout.addWidget(self.enable_hotkeys_checkBox, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.hotkeys_default_button, 1, 2, 1, 1)
